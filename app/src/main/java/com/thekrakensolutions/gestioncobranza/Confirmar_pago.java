...
public class Confirmar_pago extends AppCompatActivity {
    ...
    public Confirmar_pago _activity = this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        */
        ...
        _urlGet = "http://thekrakensolutions.com/cobradores/android_confirmar_pago.php?id_editar=" + idString + "&id=" + valueID + "&accion=true";
    ...
    */
    ...
    public void goBack(View v){
        //Intent i = new Intent(Confirmar_pago.this, Lista_clientes.class);
        Intent i = new Intent(Confirmar_pago.this, Lista_contratos.class);
        startActivity(i);
    }
    public void agregarPago(View v){
        ...
        _url = "http://thekrakensolutions.com/cobradores/android_agregar_pago.php?id_editar=" + idString + "&id=" + valueID + "&cantidad_pago=" + URLEncoder.encode(cantidadPago.getText().toString()) + "&accion=true";
        ...
        Log.d("url", _url.toString());
        new Confirmar_pago.RetrieveFeedTask().execute();
    ...
    public void cancelarPago(View v){
        //_url = "http://thekrakensolutions.com/cobradores/android_agregar_pago.php?id_editar=" + idString + "&id=" + valueID + "&accion=true";
        _url = "http://thekrakensolutions.com/cobradores/android_eliminar_pago.php?id_editar=" + idString + "&id=" + valueID + "&id_pago=" + idPago + "&accion=true";
        //_url = "http://hyperion.init-code.com/zungu/app/vt_agregar_cita.php?id_usuario=" + Integer.toString(selCliente) + "&idvh=" + Integer.toString(selVeterinario) + "&id_servicio=" + Integer.toString(selServicio) + "&motivo="+ URLEncoder.encode(txtMotivoCita.getText().toString()) + "&fecha=" + URLEncoder.encode(btnMesDia.getText().toString()) + "&hora=" + URLEncoder.encode(btnHora.getText().toString()) + "&id_veterinario=" + String.valueOf(valueID) + "&id_mascota=" + Integer.toString(selMascota);
        Log.d("url", _url.toString());
        new Confirmar_pago.RetrieveFeedTask().execute();
    ...
    public void goMenu(View v){
        Intent i = new Intent(Confirmar_pago.this, Menu.class);
        startActivity(i);
    }
    /*
