...
import com.thekrakensolutions.gestioncobranza.sendfile.SendFileReciboURL;
...
public class Detalle_pago extends AppCompatActivity {
    ...
    public Detalle_pago _activity = this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        */
        ...
        new Detalle_pago.RetrieveFeedTaskGet().execute();
            ...
            if (response == null) {
                ...
                */
                ...
                try {
                    ...
                    Intent i = new Intent(Detalle_pago.this, Detalle_pago.class);
    ...
    */
    ...
    public void goBack(View v){
        //Intent i = new Intent(Detalle_pago.this, Lista_clientes.class);
        Intent i = new Intent(Detalle_pago.this, Lista_contratos.class);
        startActivity(i);
    }
    public void imprimirPago(View v){
        showMsg("Imprimiendo");

        Intent i = new Intent(Detalle_pago.this, SendFileReciboURL.class);
        ...
        new Detalle_pago.RetrieveFeedTask().execute();
    ...
    public void goMenu(View v){
        Intent i = new Intent(Detalle_pago.this, Menu.class);
        startActivity(i);
    }
    /*
