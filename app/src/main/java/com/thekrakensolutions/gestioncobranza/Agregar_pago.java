...
public class Agregar_pago extends AppCompatActivity {
    ...
    public Agregar_pago _activity = this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //showMsg("prueba");
        //showMsg(Integer.toString(valueID));
    ...
    */
    ...
    public void agregarPago(View v){
        ...
        new Agregar_pago.RetrieveFeedTask().execute();
    ...
    public void goMenu(View v){
        Intent i = new Intent(Agregar_pago.this, Menu.class);
        startActivity(i);
    }
