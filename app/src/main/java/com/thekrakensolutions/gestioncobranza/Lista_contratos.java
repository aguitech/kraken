...
import com.thekrakensolutions.gestioncobranza.adapters.ContratosAdapter;
...
public class Lista_contratos extends AppCompatActivity {
    ListView lv;
    EditText buscador;
    Context context;
    private String _url;
    ...
    public Lista_contratos mActivity = this;
    ...
    public void goMenu(View v){
        Intent i = new Intent(Lista_contratos.this, Menu.class);
        startActivity(i);
    }
    /*
    public void goMenu(View v){
        ...
        protected void onPostExecute(String response) {
            if(response == null) {
                ...
                try {
                    ...
                    _mascotasAdapter = new ContratosAdapter(valueID, mActivity, listaNombreVeterinarios, listaImagenVeterinarios, listaIdVeterinario);
